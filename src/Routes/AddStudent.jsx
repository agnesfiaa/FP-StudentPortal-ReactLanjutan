...
import { Box, FormControl, FormLabel, Button, Input, Select, Center } from '@chakra-ui/react'
            ...
            <Box margin="4" maxWidth="500px" mx="auto">
                <form onSubmit={addStudent}>
                    <FormControl>
                        ...
                        id="input-name" onChange={({ target }) => setFullName(target.value)} 
                        value={getFullName} 
                        size="sm" w="100%" m={2} variant='filled'
                        placeholder='Enter full name'/>
                    </FormControl>
                    <FormControl>
                        <FormLabel htmlFor="input-picture">Profile Picture</FormLabel>
                        <Input type="text" 
                        id="input-picture" data-testid="profilePicture" 
                    ...
                    <FormControl>
                        ...
                        data-testid="date" onChange={({ target }) => setDate(target.value)} 
                        value={getDate}
                        size="sm" w="100%" m={2} variant='filled' />
                    </FormControl>
                    <FormControl>
                        <FormLabel htmlFor="input-gender">Gender</FormLabel>
                        <Select className="input-select" id="input-gender" 
                        data-testid="gender" onChange={({ target }) => setGender(target.value)} 
                        value={getGender}
                        size="sm" w="100%" m={2} variant='filled' >
                    ...
                    <FormControl>
                        ...
                        <Select className="input-select" data-testid="prody" 
                        id="input-prody" onChange={({ target }) => setPrody(target.value)} 
                        value={getPrody}
                        size="sm" w="100%" m={2} variant='filled'>
                    ...
                    <Center>
                        <div className="label-input">
                            ...
                            id="add-btn" className="btn-add" 
                            data-testid="add-btn" p={4}
                            bg='#668bc4' color='white' size='md' variant='solid'>
                                Add student
                            </Button>
                        </div>
                    </Center>
